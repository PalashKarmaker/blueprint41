...
{
    internal static readonly string CONSTANT_NAME = null!;
    ...
    private static object FromEnumerator<T>(object value) => new List<T>((IEnumerable<T>)value);
    ...
    internal static Parameter Constant(Parameter value) => throw new NotSupportedException();

    [Obsolete("You cannot wrap a result into a constant", true)]
    internal static Parameter Constant(Result value) => throw new NotSupportedException();

    [Obsolete("You cannot wrap a result into a constant", true)]
    internal static Parameter Constant(AliasResult value) => throw new NotSupportedException();

    [Obsolete("You cannot wrap a result into a constant", true)]
    internal static Parameter Constant(AsResult value) => throw new NotSupportedException();

    [Obsolete("You cannot wrap a result into a constant", true)]
    internal static Parameter Constant(BooleanResult value) => throw new NotSupportedException();

    [Obsolete("You cannot wrap a result into a constant", true)]
    internal static Parameter Constant(NumericResult value) => throw new NotSupportedException();

    [Obsolete("You cannot wrap a result into a constant", true)]
    internal static Parameter Constant(StringResult value) => throw new NotSupportedException();

    [Obsolete("You cannot wrap a result into a constant", true)]
    internal static Parameter Constant(DateTimeResult value) => throw new NotSupportedException();

    [Obsolete("You cannot wrap a result into a constant", true)]
    internal static Parameter Constant(RelationFieldResult value) => throw new NotSupportedException();

    [Obsolete("You cannot wrap a result into a constant", true)]
    internal static Parameter Constant(MiscResult value) => throw new NotSupportedException();

    [Obsolete("You cannot wrap a result into a constant", true)]
    internal static Parameter Constant(FloatResult value) => throw new NotSupportedException();

    [Obsolete("You cannot wrap a result into a constant", true)]
    internal static Parameter Constant(Literal value) => throw new NotSupportedException();

    #endregion Internally used for code generation?
