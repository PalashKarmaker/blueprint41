...
public class CompiledQuery
{
    ...
    internal class FieldInfo
    {
        internal FieldInfo(Transaction transaction, AsResult field)
        {
            ...
            MethodInfo? method = (entity is null) ? null : entity!.RuntimeClassType!.GetMethod("Map", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.FlattenHierarchy, null, [typeof(RawNode), typeof(string), typeof(Dictionary<string, object>), typeof(NodeMapping)], null);
            MapMethod = method is null ? null : 
                (Func<RawNode, string, Dictionary<string, object?>?, NodeMapping, OGM?>)Delegate.CreateDelegate(typeof(Func<RawNode, string, Dictionary<string, object?>?, NodeMapping, OGM?>), method, true)!;
            ...
            ConstructorInfo jaggedListCtor = jaggedListType.GetConstructor([typeof(int)])!;
