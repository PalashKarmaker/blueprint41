...
public class EntityCollection : Core.CollectionBase<Entity, DatastoreModel>
{
    ...
    public Entity New(string name, Entity? inherits = null) => New(name, name, (string?)null, inherits);
    public Entity New(string name, string prefix, Entity? inherits = null) => New(name, name, prefix, inherits);
