...
public class SubModel
{
    ...
    public SubModel AddEntity(string entity) => AddEntity(Parent.Entities[entity]);
    ...
    internal void AddEntityInternal(Entity entity) => entities.Add(entity);
    ...
    public SubModel RemoveEntity(string entity) => RemoveEntity(Parent.Entities[entity]);
    ...
    internal void RemoveEntityInternal(Entity entity) => entities.Remove(entity);
