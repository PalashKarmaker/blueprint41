...
internal class TimeDependentAddUnmanagedRelationshipAction : TimeDependentRelationshipAction
{
    ...
    protected override void InDatastoreLogic(Relationship relationship) => PersistenceProvider.AddUnmanaged(relationship, InItem!, OutItem!, Moment, EndDate, Properties);
