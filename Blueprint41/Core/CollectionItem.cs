...
public abstract class CollectionItem
{
    ...
    public bool IsBefore(DateTime moment) => EndDate < moment;
    public bool Overlaps(DateTime moment) => (StartDate <= moment && EndDate > moment);
    public bool OverlapsOrIsAttached(DateTime moment) => (StartDate <= moment && EndDate >= moment);
    ...
    public bool IsAfter(DateTime moment) => StartDate >= moment;
    ...
    public override int GetHashCode() => HashCode.Combine(Parent, Item, StartDate, EndDate);
