...
public class UnidentifiedPropertyCollection : IDictionary<string, object?>
{
    ...
    private Dictionary<string, object?> UnidentifiedBacking = [];
    ...
    internal void AddInternal(string key, object? value) => UnidentifiedBacking.Add(key, value);
    internal void ClearInternal() => UnidentifiedBacking.Clear();

    private static object? RepairList(object? value)
    {
    ...
    public bool Contains(KeyValuePair<string, object?> item) => UnidentifiedBacking.Contains(item);
