...
public abstract class EntityEventArgs
{
    ...
    internal void Flush() => Flushed = true;
...
#pragma warning disable CS0809
    ...
    public override PropertyEventArgs<T, TReturnType> As<T, TReturnType>() => base.As<T, TReturnType>();
...
#pragma warning disable CS0809
    ...
    public sealed override PropertyEventArgs<T, TReturn> As<T, TReturn>() => base.As<T, TReturn>();
    [Obsolete("You don't need to use the method 'As<TReturnType>()' to get the subclass, this already is the subclass.", true)]
    public sealed override PropertyEventArgs<TSender, T> As<T>() => base.As<T>();
#pragma warning restore CS0809
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        : this()
    {
        ...
        IsBatch = previous?.IsBatch??false;
        Cypher = previous?.Cypher??string.Empty;
