...
public class SchemaInfo_v5 : v4.SchemaInfo_v4
{
    ...
    internal override ApplyConstraintProperty NewApplyConstraintProperty(ApplyConstraintEntity parent, Property property, List<(ApplyConstraintAction, string?)> commands) => new ApplyConstraintPropertyV5(parent, property, commands);
    internal override ApplyConstraintProperty NewApplyConstraintProperty(ApplyConstraintEntity parent, string property, List<(ApplyConstraintAction, string?)> commands) => new ApplyConstraintPropertyV5(parent, property, commands);
    internal override ApplyCompositeConstraint NewApplyCompositeConstraint(ApplyConstraintEntity parent, string[] names, List<(ApplyConstraintAction, string?)> acts) =>
        new ApplyCompositeConstraintV5(parent, names, acts);
