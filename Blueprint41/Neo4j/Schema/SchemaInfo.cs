...
public class SchemaInfo
{
    ...
    protected IReadOnlyList<string> LoadSimpleData(string procedure, string resultname) => LoadData(procedure, record => record.Values[resultname].As<string>());
    protected static IReadOnlyList<T> LoadData<T>(string procedure, Func<RawRecord, T> processor)
    {
    ...
    {
        List<ApplyFunctionalId> actions = [];
