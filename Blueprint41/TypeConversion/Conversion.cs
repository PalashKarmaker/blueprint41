...
public abstract class Conversion
{
    ...
    protected static List<Conversion> registeredConverters = [];
    private static AtomicDictionary<Type, AtomicDictionary<Type, Conversion?>> cache = [];
    ...
    internal static Conversion? GetConverter(Type fromType, Type toType)
    {
        ...
        var toCache = cache.TryGetOrAdd(fromType, key => new AtomicDictionary<Type, Core.Conversion?>());
