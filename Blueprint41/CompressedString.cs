...
public sealed class CompressedString : IComparable, ICloneable, IConvertible, IEquatable<string>
{
    ...
    public object Clone() => new CompressedString(this);
    ...
    public CompressedString ToLower() => Value.ToLower()!;
    public CompressedString ToUpper() => Value.ToUpper()!;

    public CompressedString Trim() => Value.Trim()!;
    public CompressedString Trim(string trimText) => TrimStart(trimText).TrimEnd(trimText);
    public CompressedString Trim(CompressedString trimText) => TrimStart(trimText).TrimEnd(trimText);
    public CompressedString Trim(params char[] trimChars) => Value.Trim(trimChars)!;
    public CompressedString TrimStart() => Value.TrimStart()!;
    ...
    public CompressedString TrimStart(params char[] trimChars) => Value.TrimStart(trimChars)!;
    public CompressedString TrimEnd() => Value.TrimEnd()!;
    ...
    public CompressedString TrimEnd(params char[] trimChars) => Value.TrimEnd(trimChars)!;

    public CompressedString Substring(int x) => Value.Substring((int)x)!;
    public CompressedString Substring(int x, int y) => Value.Substring((int)x, (int)y)!;
    public CompressedString Replace(string x, string y) => Value.Replace(x, y)!;
    public CompressedString Replace(CompressedString x, CompressedString y) => Value.Replace(x.Value, y.Value)!;
    ...
    static public string[] Split(string input, string delimiter) => input.Split(new string[] { delimiter }, StringSplitOptions.RemoveEmptyEntries);
    static public string[] Split(string input, string delimiter, string qualifier) => Split(input, delimiter, qualifier, false);
    static public string[] Split(string input, string? delimiter, string? qualifier, bool ignoreCase)
    {
        ...
        {
            if (qualifier is not null && (string.Compare(input.Substring(i, qualifier.Length), qualifier, ignoreCase) == 0))
            {
    ...
    static public CompressedString[] Split(CompressedString input, string? delimiter, string? qualifier) => Split(input, delimiter, qualifier, false);
