...
public static class Generator
{
    ...
    public static string ToTitleCase(this string value) => CultureInfo.InvariantCulture.TextInfo.ToTitleCase(value.ToProperCase());
    ...
    public static string ToLowerCase(this string value) => value.ToProperCase().ToLowerInvariant();
    ...
    public static string ToNeo4jType(this string type) => type switch
    {
        "DateTime" => "long",
        "DateTime?" => "long?",
        "decimal" => "long",
    ...
    public static string ToXsdType(this string type) => type.Replace("?", "") switch
    {
        "bool" => "xs:boolean",
    ...
    public static string ToJsonNotation(this IEnumerable<Property> properties, Relationship? relation = null, bool prepend = false, bool creationDate = false)
    {
        ...
        if (relation is not null)
            items = items.Where(p => p.Name != Relationship.StartDate && p.Name != Relationship.EndDate && (p.Name != Relationship.CreationDate || creationDate));
